...
if submit_clicked and idx == len(features) - 1:
    ...
    with st.container():
        if prediction == 1:
            ...
            st.markdown(
                f"""
                <div style='background-color:#f8d7da; color:#721c24; padding:1rem; border-radius:10px; font-size:18px; width:100%; text-align:center;'>
